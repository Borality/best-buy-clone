...
const DATA3 = [
  ...
  {
    text: "TechMart Health",
  },
  {
    text: "TechMart Education",
  },
  {
    text: "TechMart Business",
  },
];
  ...
  return (
    <footer className="bg-[#f5f7fa] pt-6 md:pt-8">
      <div className="mx-auto w-11/12">
        {/* Link columns */}
        <div className="flex flex-col space-y-6 md:flex-row md:space-x-20 md:space-y-0 lg:space-x-32">
          <section>
      ...
      <div className="mt-6 border-t border-slate-200 bg-[#eef3f9]">
        <div className="mx-auto flex w-11/12 flex-col items-center justify-between gap-3 py-4 text-sm text-slate-700 md:flex-row">
          <p>
            © {new Date().getFullYear()} TechMart Clone — Built with Next.js &
            Tailwind
          </p>
          ...
          <div className="flex items-center gap-3 text-xl text-bestbuy_blue">
            <Link href="#" aria-label="Twitter" className="hover:text-blue-800">
              <AiOutlineTwitter />
            </Link>
            <Link
              href="#"
